    ...
    return(
        <React.Fragment>
            ...
            <div class="row">
                {/* First Column */}
                <div class="col">
                <img src="static\icon.PNG" alt="Edukated Logo"/>
                </div>
                ...
                <div className="row">
                    <div className="col-5 jumbotron rounded m-2" style={{backgroundImage: "url(https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSYXfI5S5pgQBJLaaa7hfXP8kbxXfyQzV2ZCg&usqp=CAU)",height:"70vh"}} >
                ...
                <strong>Advanced</strong> Search <strong style={floating}>...</strong><br/><br/>
                    ...
                    <button className="m-2 btn btn-warning btn-sm rounded">Search</button>
                    </div><br/><br/><br/><br/>
